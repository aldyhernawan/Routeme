              ...
              <div class="tabs-box">             
                ...
                <div >  
                  <div class="login-form">
                   ...
                   <?php 
                   if(isset($_GET['startbaru'])){
                    if($_GET['startbaru'] != '' && $_GET['tujuanbaru'] != '' && $_GET['tujuan2baru'] != ''&& $_GET['namastartbaru'] != '' && $_GET['namatujuanbaru'] != ''&& $_GET['namatujuan2baru'] != ''){
                  ?>
                  <?php include 'djikstranextrute.php'; ?>
                  <?php 
                    }
                  } 
                  ?>
                  <form action="nextrute2.php" method="get" id="signup">
                          <ol>              
                            <li>
